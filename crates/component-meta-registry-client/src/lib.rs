...
//!   `/v1/packages` endpoint (re-exported from `component-meta-registry-types`).
...
//!
//! # async fn example() -> Result<(), component_meta_registry_client::ApiError> {
...
// (`component_meta_registry_client::KnownPackage`, etc.) keep working.
pub use component_meta_registry_types::*;

// Tests for wire types live in `component-meta-registry-types`. The tests below
