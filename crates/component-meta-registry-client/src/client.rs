...
///
/// ```rust
/// use component_meta_registry_client::ApiError;
///
...
///
/// ```rust
/// use component_meta_registry_client::{KnownPackage, FetchResult};
///
...
impl RegistryClient {
    ...
    ///
    /// ```no_run
    /// use component_meta_registry_client::{RegistryClient, FetchResult};
    ///
    /// #[tokio::main]
