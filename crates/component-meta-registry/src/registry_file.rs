...
///
/// ```
/// use component_meta_registry::RegistryFile;
///
/// let toml = r#"
/// [namespace]
/// name = "wasi"
...
///
/// ```
/// use component_meta_registry::registry_file::Namespace;
///
/// let ns = Namespace {
///     name: "wasi".to_string(),
...
///
/// ```
/// use component_meta_registry::registry_file::PackageEntry;
///
...
impl RegistryFile {
    ...
    /// ```
    /// use component_meta_registry::RegistryFile;
    /// use component_meta_registry::config::PackageKind;
    ///
    /// let toml = r#"
    /// [namespace]
    /// name = "wasi"
