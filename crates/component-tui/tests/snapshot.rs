...
//!
//! Run tests with: `cargo test --package component-tui`
//!
//! # Updating Snapshots
//!
...
use component_detector::WasmEntry;
use component_package_manager::oci::ImageEntry;
use component_package_manager::storage::{KnownPackage, StateInfo};
use component_tui::components::{TabBar, TabItem};
use component_tui::views::packages::PackagesViewState;
use component_tui::views::{
...
fn test_settings_view_with_state_info_snapshot() {
    let state_info = StateInfo::new_at(
        ...
        &component_package_manager::storage::Migrations {
            current: 3,
            total: 3,
        },
        1024 * 1024 * 10, // 10 MB
