...
use app::App;
use component_package_manager::manager::{Manager, PullResult};
...
pub enum ManagerEvent {
    ...
    LocalWasmList(Vec<component_detector::WasmEntry>),
    ...
    while let Some(event) = receiver.recv().await {
        match event {
            ...
            AppEvent::DetectLocalWasm => {
                ...
                let detector = component_detector::WasmDetector::new(std::path::Path::new("."));
