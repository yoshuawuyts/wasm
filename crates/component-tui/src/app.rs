use component_package_manager::manager::PullResult;
...
pub(crate) struct App {
    ...
    /// Local WASM files
    local_wasm_files: Vec<component_detector::WasmEntry>,
    /// Log file lines
...
impl App {
    ...
    fn render_frame(&mut self, frame: &mut Frame) {
        ...
        // Render tab bar
        let tab_bar = TabBar::new(format!("component(1) - {status}"), self.current_tab);
