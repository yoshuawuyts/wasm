...
pub(crate) const INK: &[Swatch] = &[
    Swatch::new("bg-ink-900", "Ink 900", "#18181B", "oklch(.210 .006 286)", "#ECECEE", "oklch(.940 .005 286)"),
    Swatch::new("bg-ink-700", "Ink 700", "#3F3F46", "oklch(.370 .013 286)", "#B5B5BB", "oklch(.767 .008 286)"),
    Swatch::new("bg-ink-500", "Ink 500", "#71717A", "oklch(.552 .016 286)", "#8B8B92", "oklch(.627 .012 286)"),
    Swatch::new("bg-ink-400", "Ink 400", "#A1A1AA", "oklch(.705 .015 286)", "#76767D", "oklch(.546 .013 286)"),
    Swatch::new("bg-ink-300", "Ink 300", "#D4D4D8", "oklch(.871 .006 286)", "#4A4A50", "oklch(.374 .010 286)"),
];

pub(crate) const LINES: &[Swatch] = &[
    Swatch::new("bg-line", "Line", "#D4D4D8", "oklch(.871 .006 286)", "#3A3A40", "oklch(.318 .008 286)"),
    Swatch::new("bg-lineSoft", "Line Soft", "#E4E4E7", "oklch(.920 .004 286)", "#323238", "oklch(.280 .008 286)"),
];

pub(crate) const SEMANTIC: &[Swatch] = &[
    Swatch::new("bg-positive", "Positive", "#1F8A4C", "oklch(.561 .149 149)", "#5EC787", "oklch(.753 .130 152)"),
    Swatch::new("bg-cat-pinkInk", "Negative (pinkInk)", "#9B4F5E", "oklch(.490 .080 13)", "#EE7B8E", "oklch(.710 .110 13)"),
];

pub(crate) const CATEGORICAL: &[Swatch] = &[
    Swatch::cat(
        "bg-cat-blue", "Blue",
        "#D6E4FF / #3D5A99", "oklch(.910 .046 264) / oklch(.430 .102 263)",
        "#B8D0FF / #1F3F8C", "oklch(.850 .060 264) / oklch(.350 .120 263)",
        "text-cat-blueInk",
    ),
    Swatch::cat(
        "bg-cat-pink", "Pink",
        "#FBD9DF / #9B4F5E", "oklch(.910 .037 9) / oklch(.490 .080 13)",
        "#FFB8B0 / #9E2823", "oklch(.830 .060 20) / oklch(.420 .130 20)",
        "text-cat-pinkInk",
    ),
    Swatch::cat(
        "bg-cat-green", "Green",
        "#D2ECD8 / #3F7A52", "oklch(.918 .039 148) / oklch(.503 .089 149)",
        "#B5E8C0 / #1F6738", "oklch(.880 .050 148) / oklch(.430 .100 149)",
        "text-cat-greenInk",
    ),
    Swatch::cat(
        "bg-cat-peach", "Peach",
        "#F8E2C2 / #8E6529", "oklch(.911 .049 79) / oklch(.499 .089 70)",
        "#FBD3A0 / #7A4E10", "oklch(.870 .060 79) / oklch(.420 .100 70)",
        "text-cat-peachInk",
    ),
    Swatch::cat(
        "bg-cat-lilac", "Lilac",
        "#D5C8EF / #5A3D8C", "oklch(.852 .051 287) / oklch(.395 .120 287)",
        "#C6B1F0 / #422684", "oklch(.790 .070 287) / oklch(.320 .140 287)",
        "text-cat-lilacInk",
    ),
    Swatch::cat(
        "bg-cat-cream", "Cream",
        "#F4ECC2 / #7A6A2A", "oklch(.937 .055 100) / oklch(.490 .073 96)",
        "#F5E696 / #6B5610", "oklch(.910 .070 100) / oklch(.430 .080 96)",
        "text-cat-creamInk",
    ),
    Swatch::cat(
        "bg-cat-teal", "Teal",
        "#BFE3EE / #1F6F87", "oklch(.890 .037 215) / oklch(.470 .080 224)",
        "#A6DDF0 / #0F5C7A", "oklch(.860 .050 215) / oklch(.410 .090 224)",
        "text-cat-tealInk",
    ),
    Swatch::cat(
        "bg-cat-rust", "Rust",
        "#F4D2C0 / #9F5536", "oklch(.880 .045 50) / oklch(.510 .104 42)",
        "#F5BFA0 / #87401C", "oklch(.840 .060 50) / oklch(.430 .120 42)",
        "text-cat-rustInk",
    ),
    Swatch::cat(
        "bg-cat-plum", "Plum",
        "#E8C5E8 / #7E2E7E", "oklch(.851 .065 322) / oklch(.408 .135 326)",
        "#DDB2EF / #571485", "oklch(.800 .080 322) / oklch(.330 .155 326)",
        "text-cat-plumInk",
    ),
    Swatch::cat(
        "bg-cat-slate", "Slate",
        "#DADCE0 / #535A66", "oklch(.882 .005 264) / oklch(.450 .015 257)",
        "#C6CDD8 / #424B5C", "oklch(.840 .010 264) / oklch(.390 .020 257)",
        "text-cat-slateInk",
    ),
];
