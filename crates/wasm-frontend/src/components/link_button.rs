...
const PRIMARY_CLASS: &str = "h-9 px-4 inline-flex items-center rounded-lg bg-ink-900 text-canvas text-[13px] font-medium hover:bg-ink-700 transition-colors";

/// Class string for an outline link-button.
const OUTLINE_CLASS: &str = "h-9 px-4 inline-flex items-center rounded-lg border-[1.5px] border-ink-900 bg-surface text-ink-900 text-[13px] hover:bg-surfaceMuted transition-colors";
